\documentclass[letterpaper,titlepage,&1&pt,oneside]{article}
...
\cline{2-11}
\end{tabular}
\caption{Abbreviated Truth Table for Overlap}\label{table:OverLap_Unminimized}
\end{table}
